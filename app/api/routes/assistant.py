...
async def create_transcription(
    ...
    if duration_seconds is not None and duration_seconds > settings.assistant_audio_max_seconds:
        raise HTTPException(status_code=413, detail={"code": "AUDIO_TOO_LONG", "message": "录音不能超过 30 秒"})
    filename, content_type, content = normalize_audio_upload(
