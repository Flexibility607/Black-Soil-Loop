    ...
    db_session.add_all(
        [
            ...
            Bom(**tracked(source_record_id="BOM-LEAD-001", bom_id="BOM-LEAD-001", enterprise_id="ENT-001", product_id="PRODUCT-LEAD-001", product_name="冷冻水饺", material_id="MATERIAL-LEAD-001", material_name="面粉", unit_usage_kg=0.5, unit_usage_unit="kg", status="ACTIVE")),
                ProcurementHistory(**tracked(source_record_id="PURCHASE-LEAD-001", purchase_record_id="PURCHASE-LEAD-001", enterprise_id="ENT-001", purchased_at=datetime(2026, 7, 15, tzinfo=timezone.utc), material_id="MATERIAL-LEAD-001", material_name="面粉", quantity_kg=100, unit_price=5, currency="CNY", supplier_id="SUP-001", supplier_name="生产商甲", supplier_type="OTHER_PRODUCER", status="VALID")),
                ProcurementHistory(**tracked(source_record_id="PURCHASE-LEAD-002", purchase_record_id="PURCHASE-LEAD-002", enterprise_id="ENT-001", purchased_at=datetime(2026, 7, 15, tzinfo=timezone.utc), material_id="MATERIAL-LEAD-001", material_name="面粉", quantity_kg=100, unit_price=4, currency="CNY", supplier_id="PARK-DIRECT", supplier_name="园区直供", supplier_type="PARK_DIRECT", status="VALID")),
        ]
    )
    db_session.commit()
