...
test('同源录音 Worklet 与 WAV Worker 完整进入生产构建', async () => {
  ...
  assert.match(voice, /new URL\('\.\/dashboard-audio-worklet\.js\?v=20260814-dashboard-presentation-5'/);
  assert.match(voice, /new URL\('\.\/dashboard-wav-worker\.js\?v=20260814-dashboard-presentation-5'/);
