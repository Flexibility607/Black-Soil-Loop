...
test('E02 保留语音入口和两个经营占比环图', async () => {
  ...
  assert.match(html, /dashboard-v2\.js\?v=20260815-demand-summary-1/);
  assert.match(html, /api\.js\?v=20260815-demand-summary-1/);
...
test('同源录音 Worklet 与 WAV Worker 完整进入生产构建', async () => {
  ...
  assert.match(voice, /new URL\('\.\/dashboard-audio-worklet\.js\?v=20260815-demand-summary-1'/);
  assert.match(voice, /new URL\('\.\/dashboard-wav-worker\.js\?v=20260815-demand-summary-1'/);
