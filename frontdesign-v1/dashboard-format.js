...
export const SCREEN_PALETTES = Object.freeze({
  night: Object.freeze({
    ...
    mapRoadLabel: '#78aebe',
    mapSharedRoute: 'rgba(170, 220, 236, 0.72)',
    routeColors: Object.freeze(['#51df84', '#55c8ff', '#f6bd4d', '#9b85ff', '#ff7b72']),
    vehicle: '#f4c96b',
  ...
  day: Object.freeze({
    ...
    mapRoadLabel: '#426b80',
    mapSharedRoute: 'rgba(62, 109, 133, 0.68)',
    routeColors: Object.freeze(['#168553', '#1677b8', '#a56a08', '#7651b9', '#c84f48']),
    vehicle: '#a56a08',
